		...
		<Container>
			...
			<div className='contenedor'>
				<div className='card1'>
					...
					<p>
						Aprende de manera presencial o virtual con nuestros cursos online y
						en vivo dictados a través de videoconferencia.
					</p>
				</div>
				<div className='card2'>
					...
					<p>
						Trabaja en proyectos reales junto a profesionales expertos, estudia
						de una manera diferente y prepárate para el futuro.
					</p>
				</div>
				<div className='card3'>
